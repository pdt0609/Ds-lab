...
def load_dataset():
    train_data_reader = DataReader(
        data_path='C:\\Users\\msthu\\PycharmProjects\\pythonProject1\\Training phase I\\SESSION3\\DATA\\20news-train-tfidf.txt',
        batch_size=50,
        vocab_size=vocab_size
    )
    test_data_reader = DataReader(
        data_path='C:\\Users\\msthu\\PycharmProjects\\pythonProject1\\Training phase I\\SESSION3\\DATA\\20news-test-tfidf.txt',
        batch_size=50,
        vocab_size=vocab_size
    )
...
def save_parameters(name, value, epoch):
    ...
    with open('C:\\Users\\msthu\\PycharmProjects\\pythonProject1\\Training phase I\\SESSION3\\DATA\\saved-paras/' + filename, 'w') as f:
        f.write(string_form)
...
def restore_parameters(name, epoch):
    filename = name.replace(':', '-colon-') + '-epoch-{}.txt'.format(epoch)
    with open('C:\\Users\\msthu\\PycharmProjects\\pythonProject1\\Training phase I\\SESSION3\\DATA\\saved-paras/' + filename) as f:
...
with open('C:\\Users\\msthu\\PycharmProjects\\pythonProject1\\Training phase I\\SESSION3\\DATA\\words_idfs.txt') as f:
