...
def train_and_evaluate_RNN():
    with open('C:\\Users\\msthu\\PycharmProjects\\pythonProject1\\Training phase I\\SESSION4\\DATA\\vocab-raw.txt') as f:
    ...
    with tf.Session() as sess:
        train_data_reader = DataReader(
            data_path='C:\\Users\\msthu\\PycharmProjects\\pythonProject1\\Training phase I\\SESSION4\\DATA\\20news-train-encoded.txt',
            batch_size=50,
        )
        test_data_reader = DataReader(
            data_path='C:\\Users\\msthu\\PycharmProjects\\pythonProject1\\Training phase I\\SESSION4\\DATA\\20news-test-encoded.txt',
            batch_size=50,
        )
        step = 0
        MAX_STEP = 10000
