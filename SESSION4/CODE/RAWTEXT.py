...
def gen_data_and_vocab():
    ...
    path = 'C:\\Users\\msthu\\PycharmProjects\\pythonProject1\\Training phase I\\SESSION4\\DATA\\'
    ...
    vocab.sort()
    with open('C:\\Users\\msthu\\PycharmProjects\\pythonProject1\\Training phase I\\SESSION4\\DATA\\vocab-raw.txt', 'w') as f:
        f.write('\n'.join(vocab))
    ...
    with open('C:\\Users\\msthu\\PycharmProjects\\pythonProject1\\Training phase I\\SESSION4\\DATA\\20news-train-raw.txt', 'w') as f:
        f.write('\n'.join(train_data))

    with open('C:\\Users\\msthu\\PycharmProjects\\pythonProject1\\Training phase I\\SESSION4\\DATA\\20news-test-raw.txt', 'w') as f:
        f.write('\n'.join(test_data))
